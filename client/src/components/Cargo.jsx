        ...
        <div className="w-full lg:w-1/2">
          <div className="w-full p-4 pr-4 mt-4 lg:px-12">
            ...
            >
              ...
              <br />
              <br />
              The lift consists mainly of cargo lifts.<br/>
              Fast and safe
              transportation of goods from low to high weight.
              <br />
              <br />
              It is commonly used for container loading, warehouse loading, machine transportation, and various product transportation, which requires reduction of manpower and labor costs.
            </motion.p>
          </div>
        </div>
        <div className="w-full lg:w-1/2">
        ...
        <div className="w-full lg:w-1/2">
          <div className="flex justify-center mb-6">
            <motion.img
              ...
              src="/images/machinery/Cargo-lift-1.jpg"
              alt="cargo-1"
              className="w-[500px] rounded-3xl px-2"
            />
          </div>
        ...
        <div className="w-full lg:w-1/2">
          <div className="flex justify-center mb-6">
            <motion.img
              ...
              animate={{ x: 0, opacity: 0.8 }}
              transition={{ duration: 1 }}
              src="/images/machinery/table-hydraulic.jpg"
              alt="table hydraulic"
              className="w-[500px] rounded-3xl px-2"
            />
          </div>
