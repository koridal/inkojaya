      ...
      <div className='flex flex-wrap max-w-6xl mx-auto mt-10'>
        <div className="w-full lg:w-1/2">
          <div className="w-full p-4 pr-4 mt-4 lg:px-12">
            ...
            >
              ...
              A mixer is a facility that mixes extruded and raw materials in an injection machine at an exact ratio.
              <br />
              <br />
              This is an essential machine for all product manufacturing plants with extrusion and injection.
              <br />
              <br />
        ...
        <div className="flex justify-center mb-6">
          <motion.img
            ...
            transition={{ duration: 0.5 }}
            src="/images/machinery/mixer-2.png"
            alt="mixer-2"
        ...
        <div className="w-full lg:w-1/2">
          <div className="flex justify-center mb-6">
            <motion.img
              ...
              src="/images/machinery/mixer-1.png"
              alt="mixer-1"
              className="w-[500px] rounded-3xl px-2"
            />
          </div>
        ...
        <div className="w-full lg:w-1/2">
          <div className="flex justify-center mb-6">
            <motion.img
              ...
              animate={{ x: 0, opacity: 0.8 }}
              transition={{ duration: 1 }}
              src="/images/machinery/mixer-3.png"
              alt="mixer-3"
              className="w-[500px] rounded-3xl px-2"
            />
          </div>
